...
IDE-FILE-RESOLUTION:
  ...
  - Example: update-knowledge.md -> .1pb-squad/development/tasks/update-knowledge.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .1pb-squad/development/scripts/unified-activation-pipeline.js roadmap-sentinel
