...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-doc.md -> .1pb-squad/development/tasks/create-doc.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .1pb-squad/development/scripts/unified-activation-pipeline.js config-engineer
