...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-skill.md -> .1pb-squad/development/tasks/create-skill.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .1pb-squad/development/scripts/unified-activation-pipeline.js skill-craftsman
...
dependencies:
  reference_knowledge:
    ...
    spec_driven_development:
      ...
      aios_mapping: |
        AIOS tasks (.1pb-squad/development/tasks/) map to Claude Code skills (.claude/skills/)
...
command_blueprints:
  ...
  map-aios-to-skills:
    ...
    steps:
      - step: 1
        ...
        scan:
          - ".1pb-squad/development/tasks/*.md"
          - ".1pb-squad/development/agents/*.md"
          - ".1pb-squad/development/templates/"
          - ".1pb-squad/development/checklists/"
          - ".1pb-squad/development/workflows/"
      - step: 2
  ...
  convert-task-to-skill:
    ...
    steps:
      - step: 1
        action: "Read AIOS task from .1pb-squad/development/tasks/{task-name}"
      - step: 2
...
3. For AIOS integration: `.1pb-squad/` directory present
...
|-------------|----------------------|
| Task (`.1pb-squad/development/tasks/`) | Skill (`.claude/skills/`) |
