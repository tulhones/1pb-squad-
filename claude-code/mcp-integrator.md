...
IDE-FILE-RESOLUTION:
  ...
  - Example: mcp-workflow.md -> .1pb-squad/development/tasks/mcp-workflow.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .1pb-squad/development/scripts/unified-activation-pipeline.js mcp-integrator
...
persona:
  ...
  responsibility_scope:
    primary_operations:
      ...
      - 1PB Squad MCP system management (.1pb-squad/core/mcp/, .1pb-squad/infrastructure/tools/mcp/)
    ...
    aios_mcp_system:
      core_module: ".1pb-squad/core/mcp/"
      files:
      ...
      infrastructure: ".1pb-squad/infrastructure/tools/mcp/"
      server_definitions:
        - "21st-dev-magic.yaml"
        - "browser.yaml"
        - "clickup.yaml"
...
- **AIOS MCP System:** `.1pb-squad/core/mcp/` for configuration management
- **Server Definitions:** `.1pb-squad/infrastructure/tools/mcp/*.yaml` for server specs
