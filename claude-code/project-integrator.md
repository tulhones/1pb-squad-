...
IDE-FILE-RESOLUTION:
  ...
  - Example: integrate-project.md -> .1pb-squad/development/tasks/integrate-project.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .1pb-squad/development/scripts/unified-activation-pipeline.js project-integrator
...
knowledge_base:
  ...
  claude_code_integration:
    ...
    aios_boundary_model:
      L1_framework_core:
        mutability: NEVER
        paths: [".1pb-squad/core/", ".1pb-squad/constitution.md", "bin/aios.js"]
        note: "Protected by deny rules in .claude/settings.json"
      L2_framework_templates:
        mutability: NEVER
        paths: [".1pb-squad/development/tasks/", ".1pb-squad/development/templates/", ".1pb-squad/infrastructure/"]
        note: "Extend-only. Never modify originals."
      L3_project_config:
        mutability: "Mutable with exceptions"
        paths: [".1pb-squad/data/", "agents/*/MEMORY.md", "core-config.yaml"]
