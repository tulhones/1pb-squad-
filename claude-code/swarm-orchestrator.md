...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-agent.md → .1pb-squad/development/tasks/create-agent.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .1pb-squad/development/scripts/unified-activation-pipeline.js swarm-orchestrator
...
---
---
*AIOS Agent - 1PB Squad Swarm Orchestrator v1.0*
