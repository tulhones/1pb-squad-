...
| Brand | 15 | Branding e posicionamento (David Aaker, Marty Neumeier, Al Ries...) |
| C-Level | 6 | Liderança executiva (CEO, CTO, CMO, COO, CIO, CAIO) |
| Claude Code | 8 | Domínio do Claude Code |
| Copy | 23 | Copywriting (Gary Halbert, Eugene Schwartz, David Ogilvy...) |
| Cybersecurity | 15 | Segurança ofensiva e defensiva |
| Data | 7 | Analytics, growth e comunidade (Sean Ellis, Avinash Kaushik...) |
...
Após a instalação, abra o Claude Code em qualquer projeto e chame os agentes com `/`:
...
- [Claude Code](https://claude.ai/code) — CLI da Anthropic (gratuito)

Só isso. Nada mais.

---

**1PB Squad** — Feito para quem toca o próprio negócio.
